...
def dfs_start(matriz, inicio, fim):
    aux = deepcopy(matriz)
    ...
    dfs_rec(matriz, inicio, fim, encontrou, nos)
...
def dfs_rec(matriz, atual, fim, encontrou, nos):
    a0 = atual[0]
    a1 = atual[1]
    f0 = fim[0]
    f1 = fim[1]
